...
def new_store():
    ...
    if form.validate_on_submit():
        ...
        flash ('New store successfully got added!')
...
def new_item():
    ...
    if form.validate_on_submit():
        ...
        flash('New item successfully got added!')
...
def add_to_shopping_list(item_id):
    ...
    db.session.commit()
    flash('New item was successfully added to your shopping list!')
...
def shopping_list():
    ...
    return render_template('shopping_list.html', shopping_list=user_shopping_items)
